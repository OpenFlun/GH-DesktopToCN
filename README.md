...
- 请先阅读项目中的'注意事项.txt' 和 'localization.md',了解编写规则;
...
| ['VS自定义外部工具指南.md'](./VS自定义外部工具指南.md)     | 在 Visual Studio 中集成一键构建按钮            |

**快速开始**：
1. 确保系统为 **64 位 Windows**;
2. 安装 Visual Studio 2026 Build Tools（含 MSVC v143）和 Qt 6.11.0 (msvc2022_64) ->当前版本只是示例请根据自己安装的版本进行配置;
